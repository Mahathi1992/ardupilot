...
#define MAVLINK_THIS_XML_HASH 9119461827671114181
...
#ifndef HAVE_ENUM_ZAS_MOUNT_MODE
#define HAVE_ENUM_ZAS_MOUNT_MODE
typedef enum ZAS_MOUNT_MODE
{
   ZAS_MOUNT_MODE_HOME=0, /*  Load and keep HOME position  | */
   ZAS_MOUNT_MODE_STABILIZE=1, /*  Mode for ZAS gimbal stabilization. | */
   ZAS_MOUNT_MODE_GEOPOINT=2, /*  Mode for ZAS gimbal geopointing with lat, lng, amsl.  | */
   ZAS_MOUNT_MODE_PILOT=3, /*  Pilot controlled ZAS gimbal mode.  | */
   ZAS_MOUNT_MODE_STOW=4, /*  Storage mode.  | */
   ZAS_MOUNT_MODE_CALIBRATE=5, /*  ZAS gimbal calibration mode.  | */
   ZAS_MOUNT_MODE_HOME_TRACK=6, /*  Gimbal tracks selected area in the image.  | */
   ZAS_MOUNT_MODE_HOME_TRACK_LOCK=7, /*  Gimbal tracks selected area in the image but locks pan and tilt.   | */
   ZAS_MOUNT_MODE_ZOOMRATE=200, /*  Gimbal Zoomrate Mode.   | */
   ZAS_MOUNT_MODE_ZOOMPOS=201, /*  Gimbal Zoom position dt change.   | */
   ZAS_MOUNT_MODE_TRACKBOX_NUDGE=202, /*  Gimbal track box row, col.   | */
   ZAS_MOUNT_MODE_TRACKBOX_SIZE=203, /*  Gimbal track box size.   | */
   ZAS_MOUNT_MODE_WHOT_BHOT=204, /*  White hot / black hot status   | */
   ZAS_MOUNT_MODE_REBOOT=250, /*  Gimbal Reboot  | */
   ZAS_MOUNT_MODE_ENUM_END=251, /*  | */
} ZAS_MOUNT_MODE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_ZMOTION_CUSTOM_CMD_TYPES
#define HAVE_ENUM_ZMOTION_CUSTOM_CMD_TYPES
typedef enum ZMOTION_CUSTOM_CMD_TYPES
{
   PAYLOAD2_COMMANDS=0, /* Commands sent are of Payload2 type | */
   ZMOTION_OTHERS=1, /* Other ZMOTION Commands | */
   ZMOTION_CUSTOM_CMD_TYPES_ENUM_END=2, /*  | */
} ZMOTION_CUSTOM_CMD_TYPES;
#endif

/** @brief  */
#ifndef HAVE_ENUM_PAYLOAD2_CMD
#define HAVE_ENUM_PAYLOAD2_CMD
typedef enum PAYLOAD2_CMD
{
   PAYLOAD2_GET=0, /* Get Values | */
   PAYLOAD2_HEALTH_CHECK=1, /* Health Check | */
   PAYLOAD2_UNUSED=2, /* UNUSED | */
   PAYLOAD2_ARM=3, /* ARM | */
   PAYLOAD2_DISARM=4, /* DISARM | */
   PAYLOAD2_TEST_CONFIGURATION=5, /* TEST CONFIGURATION | */
   PAYLOAD2_CMD_ENUM_END=6, /*  | */
} PAYLOAD2_CMD;
#endif
...
typedef enum PLANE_MODE
{
   ...
   PLANE_MODE_GIMBALNAV=26, /*  | */
   PLANE_MODE_TRACK2D=27, /*  | */
   PLANE_MODE_TRACK3D=28, /*  | */
   PLANE_MODE_GPSDive=29, /*  | */
   PLANE_MODE_VBTG=30, /*  | */
   PLANE_MODE_ENUM_END=31, /*  | */
} PLANE_MODE;
#endif
...
#include "./mavlink_msg_zas_track3d_parameters.h"
#include "./mavlink_msg_zas_track_status.h"
#include "./mavlink_msg_zas_track_parameters.h"
#include "./mavlink_msg_zas_gpsd_parameters.h"
#include "./mavlink_msg_zas_gimbal_zoom_cmd.h"
#include "./mavlink_msg_zas_gimbal_usr_cmd.h"
#include "./mavlink_msg_zas_gimbal_usr_cmd_pilot_stab.h"
#include "./mavlink_msg_zas_gimbal_usr_cmd_geopoint.h"
#include "./mavlink_msg_zas_gimbal_status_msg.h"
#include "./mavlink_msg_zmotion_command.h"
#include "./mavlink_msg_zmotion_command_response.h"
#include "./mavlink_msg_zmotion_payload2_response.h"
