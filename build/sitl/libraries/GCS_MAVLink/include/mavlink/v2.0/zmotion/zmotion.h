/** @file
 *  @brief MAVLink comm protocol generated from zmotion.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_ZMOTION_H
#define MAVLINK_ZMOTION_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_ZMOTION.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#undef MAVLINK_THIS_XML_HASH
#define MAVLINK_THIS_XML_HASH 1709293190400426115
