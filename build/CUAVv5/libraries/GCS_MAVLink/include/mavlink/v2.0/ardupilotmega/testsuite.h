...
static void mavlink_test_zas_track3d_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ZAS_TRACK3D_PARAMETERS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_zas_track3d_parameters_t packet_in = {
        963497464,963497672,17651,17755,17859
    };
    mavlink_zas_track3d_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.approach_latitude = packet_in.approach_latitude;
        packet1.approach_longitude = packet_in.approach_longitude;
        packet1.abort_dive_altitude = packet_in.abort_dive_altitude;
        packet1.dive_pitch = packet_in.dive_pitch;
        packet1.dive_airspeed = packet_in.dive_airspeed;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ZAS_TRACK3D_PARAMETERS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ZAS_TRACK3D_PARAMETERS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track3d_parameters_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_zas_track3d_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track3d_parameters_pack(system_id, component_id, &msg , packet1.abort_dive_altitude , packet1.approach_latitude , packet1.approach_longitude , packet1.dive_pitch , packet1.dive_airspeed );
    mavlink_msg_zas_track3d_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track3d_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.abort_dive_altitude , packet1.approach_latitude , packet1.approach_longitude , packet1.dive_pitch , packet1.dive_airspeed );
    mavlink_msg_zas_track3d_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_zas_track3d_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track3d_parameters_send(MAVLINK_COMM_1 , packet1.abort_dive_altitude , packet1.approach_latitude , packet1.approach_longitude , packet1.dive_pitch , packet1.dive_airspeed );
    mavlink_msg_zas_track3d_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ZAS_TRACK3D_PARAMETERS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ZAS_TRACK3D_PARAMETERS) != NULL);
#endif
}

static void mavlink_test_zas_track_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ZAS_TRACK_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_zas_track_status_t packet_in = {
        963497464,963497672,17651,17755,17859,17963,18067,187
    };
    mavlink_zas_track_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.track_latitude = packet_in.track_latitude;
        packet1.track_longitude = packet_in.track_longitude;
        packet1.num_tracks = packet_in.num_tracks;
        packet1.pan = packet_in.pan;
        packet1.tilt = packet_in.tilt;
        packet1.commanded_pan = packet_in.commanded_pan;
        packet1.commanded_tilt = packet_in.commanded_tilt;
        packet1.selected_cam = packet_in.selected_cam;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ZAS_TRACK_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ZAS_TRACK_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_zas_track_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_status_pack(system_id, component_id, &msg , packet1.track_latitude , packet1.track_longitude , packet1.num_tracks , packet1.selected_cam , packet1.pan , packet1.tilt , packet1.commanded_pan , packet1.commanded_tilt );
    mavlink_msg_zas_track_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.track_latitude , packet1.track_longitude , packet1.num_tracks , packet1.selected_cam , packet1.pan , packet1.tilt , packet1.commanded_pan , packet1.commanded_tilt );
    mavlink_msg_zas_track_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_zas_track_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_status_send(MAVLINK_COMM_1 , packet1.track_latitude , packet1.track_longitude , packet1.num_tracks , packet1.selected_cam , packet1.pan , packet1.tilt , packet1.commanded_pan , packet1.commanded_tilt );
    mavlink_msg_zas_track_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ZAS_TRACK_STATUS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ZAS_TRACK_STATUS) != NULL);
#endif
}

static void mavlink_test_zas_track_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ZAS_TRACK_PARAMETERS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_zas_track_parameters_t packet_in = {
        963497464,963497672,17651,17755,17859,17963,18067,18171
    };
    mavlink_zas_track_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.max_misses_before_tracking_lost = packet_in.max_misses_before_tracking_lost;
        packet1.step_value = packet_in.step_value;
        packet1.confidence_threshold = packet_in.confidence_threshold;
        packet1.center_offset_pixel_delta = packet_in.center_offset_pixel_delta;
        packet1.cam0_height = packet_in.cam0_height;
        packet1.cam0_width = packet_in.cam0_width;
        packet1.cam1_height = packet_in.cam1_height;
        packet1.cam1_width = packet_in.cam1_width;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ZAS_TRACK_PARAMETERS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ZAS_TRACK_PARAMETERS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_parameters_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_zas_track_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_parameters_pack(system_id, component_id, &msg , packet1.confidence_threshold , packet1.max_misses_before_tracking_lost , packet1.step_value , packet1.center_offset_pixel_delta , packet1.cam0_height , packet1.cam0_width , packet1.cam1_height , packet1.cam1_width );
    mavlink_msg_zas_track_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.confidence_threshold , packet1.max_misses_before_tracking_lost , packet1.step_value , packet1.center_offset_pixel_delta , packet1.cam0_height , packet1.cam0_width , packet1.cam1_height , packet1.cam1_width );
    mavlink_msg_zas_track_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_zas_track_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_track_parameters_send(MAVLINK_COMM_1 , packet1.confidence_threshold , packet1.max_misses_before_tracking_lost , packet1.step_value , packet1.center_offset_pixel_delta , packet1.cam0_height , packet1.cam0_width , packet1.cam1_height , packet1.cam1_width );
    mavlink_msg_zas_track_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ZAS_TRACK_PARAMETERS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ZAS_TRACK_PARAMETERS) != NULL);
#endif
}

static void mavlink_test_zas_gpsd_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ZAS_GPSD_PARAMETERS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_zas_gpsd_parameters_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,963498712,963498920,963499128,19107,19211,19315,19419,19523,15
    };
    mavlink_zas_gpsd_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.approach_latitude = packet_in.approach_latitude;
        packet1.approach_longitude = packet_in.approach_longitude;
        packet1.approach_altitude = packet_in.approach_altitude;
        ...
        packet1.abort_latitude = packet_in.abort_latitude;
        packet1.abort_longitude = packet_in.abort_longitude;
        packet1.abort_altitude = packet_in.abort_altitude;
        packet1.abort_dive_altitude = packet_in.abort_dive_altitude;
        packet1.approach_loiter_radius = packet_in.approach_loiter_radius;
        packet1.dive_pitch_saturation = packet_in.dive_pitch_saturation;
        packet1.pitch_offset = packet_in.pitch_offset;
        packet1.target_heading = packet_in.target_heading;
        packet1.loiter_direction = packet_in.loiter_direction;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ZAS_GPSD_PARAMETERS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ZAS_GPSD_PARAMETERS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_gpsd_parameters_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_zas_gpsd_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_gpsd_parameters_pack(system_id, component_id, &msg , packet1.abort_dive_altitude , packet1.approach_loiter_radius , packet1.approach_latitude , packet1.approach_longitude , packet1.approach_altitude , packet1.target_latitude , packet1.target_longitude , packet1.target_altitude , packet1.abort_latitude , packet1.abort_longitude , packet1.abort_altitude , packet1.loiter_direction , packet1.dive_pitch_saturation , packet1.pitch_offset , packet1.target_heading );
    mavlink_msg_zas_gpsd_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_gpsd_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.abort_dive_altitude , packet1.approach_loiter_radius , packet1.approach_latitude , packet1.approach_longitude , packet1.approach_altitude , packet1.target_latitude , packet1.target_longitude , packet1.target_altitude , packet1.abort_latitude , packet1.abort_longitude , packet1.abort_altitude , packet1.loiter_direction , packet1.dive_pitch_saturation , packet1.pitch_offset , packet1.target_heading );
    mavlink_msg_zas_gpsd_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_zas_gpsd_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_zas_gpsd_parameters_send(MAVLINK_COMM_1 , packet1.abort_dive_altitude , packet1.approach_loiter_radius , packet1.approach_latitude , packet1.approach_longitude , packet1.approach_altitude , packet1.target_latitude , packet1.target_longitude , packet1.target_altitude , packet1.abort_latitude , packet1.abort_longitude , packet1.abort_altitude , packet1.loiter_direction , packet1.dive_pitch_saturation , packet1.pitch_offset , packet1.target_heading );
    mavlink_msg_zas_gpsd_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ZAS_GPSD_PARAMETERS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ZAS_GPSD_PARAMETERS) != NULL);
#endif
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_zas_track3d_parameters(system_id, component_id, last_msg);
    mavlink_test_zas_track_status(system_id, component_id, last_msg);
    mavlink_test_zas_track_parameters(system_id, component_id, last_msg);
    mavlink_test_zas_gpsd_parameters(system_id, component_id, last_msg);
}
