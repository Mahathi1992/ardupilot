...
public:
    ...
    uint8_t camera_mode; //Added by Akash 
    ...
    */
    ...
    void set_camera_mode(uint8_t id); //Added by Akash
    void send_camera_settings_status() const; //Added by Akash 
    //void send_payload2_message() const; // Added by Akshay
...
protected:
    ...
    void handle_zas_gimbal_cmd_message(const mavlink_message_t &msg);
