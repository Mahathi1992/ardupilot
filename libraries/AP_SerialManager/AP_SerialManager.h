...
// MSP protocol default buffer sizes
#define AP_SERIALMANAGER_DYNAMYIXEL_MX_BUFSIZE_RX     128
#define AP_SERIALMANAGER_DYNAMYIXEL_MX_BUFSIZE_TX     16
#define AP_SERIALMANAGER_DYNAMYIXEL_MX_BAUD           1000000

// MSP protocol default buffer sizes
#define AP_SERIALMANAGER_SIGHTLINE_BUFSIZE_RX     512
#define AP_SERIALMANAGER_SIGHTLINE_BUFSIZE_TX     8
#define AP_SERIALMANAGER_SIGHTLINE_BAUD           57600

// MSP protocol default buffer sizes
#define AP_SERIALMANAGER_ZASDEBUG_BUFSIZE_RX     16
#define AP_SERIALMANAGER_ZASDEBUG_BUFSIZE_TX     8
#define AP_SERIALMANAGER_ZASDEBUG_BAUD           57600

// MSP protocol default buffer sizes
#define AP_SERIALMANAGER_PAYLOAD2_BUFSIZE_RX     128
#define AP_SERIALMANAGER_PAYLOAD2_BUFSIZE_TX     8
#define AP_SERIALMANAGER_PAYLOAD2_BAUD           115200
...
public:
    ...
    enum SerialProtocol {
        ...
        SerialProtocol_Dynamixel_MX = 43,
        SerialProtocol_SightLine = 44,
        SerialProtocol_ZASDebug = 45,
        SerialProtocol_EOCamera = 46,
        SerialProtocol_IRCamera = 47,
        SerialProtocol_Payload2 = 48,
        SerialProtocol_AlexmosV2 = 49,
    ...
    // Get Payload2 Driver -- Akshay
    AP_HAL::UARTDriver* get_payload2_uart();
    AP_HAL::UARTDriver* get_alexmos2_uart();
...
protected:
    AP_HAL::UARTDriver* payload2, *alexmos2;
};
